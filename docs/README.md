...
| `handoff-docs-index.md` | Finding handoff packet behavior, review matrix, and guardrail test coverage docs. |
...
For Discord trading assistant or ChatGPT web review handoff work, include `docs/discord-trading-skill-trigger-architecture.md`, `docs/chatgpt-handoff-packet-contract.md`, `docs/local-discord-handoff-implementation-plan.md`, and `docs/handoff-docs-index.md`.
