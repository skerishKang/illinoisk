...
def test_valid_signal_maps_to_진입():
    print("\n테스트 2: valid_signal maps to 진입")
    snapshot = build_fixture_snapshot(
        indicator_overrides={
            "rsi_1m": 29.5,
            "rsi_5m": 35.0,
...
def test_invalid_signal_maps_to_제외():
    print("\n테스트 5: invalid_signal maps to 제외")
    snapshot = build_fixture_snapshot(
        indicator_overrides={
            "rsi_1m": 58.0,
            "rsi_5m": 58.0,
...
def test_all_signal_states_mapped():
    print("\n테스트 7: all SIGNAL_STATES have DECISION mapping")
...
def test_dedupe_in_output_lists():
    print("\n테스트 8: output lists are deduplicated")
